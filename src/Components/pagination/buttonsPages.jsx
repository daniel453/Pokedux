export function ButtonPages({ handlePage, totalPages, getMorePokemons, page }) {
  let initialButtons = []
  let middleButtons = []
  let endButtons = []
  ...
  console.log(page)
  return (
    <div className="hidden items-center w-10/12 justify-center box-border sm:flex">
      <div className="flex text-center after:ml-3">
        {
      ...
      <div className="flex ml-3 text-center after:ml-3">
        {
